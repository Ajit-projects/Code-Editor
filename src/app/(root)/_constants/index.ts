...
type LanguageConfig = Record<
  string,
  {
    ...
    label: string;
    logoPath: string;
    apiRuntime: { language: string; version: string };
...
export const LANGUAGE_CONFIG: LanguageConfig = {
  javascript: {
    ...
    apiRuntime: { language: "javascript", version: "18.15.0" }, // api that we're gonna be using
...
console.log('Sum of numbers:', sum);`,
  ...
  typescript: {
    ...
    apiRuntime: { language: "typescript", version: "5.0.3" },
...
console.log('Sum of numbers:', math.sum());`,
  ...
  python: {
    ...
    label: "Python",
    logoPath: "/python.png",
    apiRuntime: { language: "python", version: "3.10.0" },
...
print(f"Sum of numbers: {numbers_sum}")`,
  ...
  java: {
    ...
    label: "Java",
    logoPath: "/java.png",
    apiRuntime: { language: "java", version: "15.0.2" },
    monacoLanguage: "java",
  ...
  go: {
    ...
    label: "Go",
    logoPath: "/go.png",
    apiRuntime: { language: "go", version: "1.16.2" },
    monacoLanguage: "go",
...
func main() {
  ...
  rust: {
    ...
    label: "Rust",
    logoPath: "/rust.png",
    apiRuntime: { language: "rust", version: "1.68.2" },
    monacoLanguage: "rust",
    defaultCode: `fn main() {
    // Create vector
  ...
  cpp: {
    ...
    label: "C++",
    logoPath: "/cpp.png",
    apiRuntime: { language: "cpp", version: "10.2.0" },
    monacoLanguage: "cpp",
...
int main() {
  ...
  csharp: {
    ...
    label: "C#",
    logoPath: "/csharp.png",
    apiRuntime: { language: "csharp", version: "6.12.0" },
...
class Program {
  ...
  ruby: {
    ...
    label: "Ruby",
    logoPath: "/ruby.png",
    apiRuntime: { language: "ruby", version: "3.0.1" },
    monacoLanguage: "ruby",
...
puts "Sum of numbers: #{sum}"`,
  ...
  swift: {
    ...
    label: "Swift",
    logoPath: "/swift.png",
    apiRuntime: { language: "swift", version: "5.3.3" },
